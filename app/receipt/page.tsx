...
// app/invoice/page.tsx or pages/invoice.tsx
...
;
 ...
 style={{
  ...
  paddingBottom: '40px',
       ...
       <button type="button"
          onClick={handlePrint}
          className="text-xl text-white p-3 px-5 print:hidden" style={{ backgroundColor: '#004e5a' }}>print</button>
       </div>
               {/* Header */}
 ...
 <div className="text-3xl font-bold">INVOICE</div>
       ...
       <div><p className="my-6 ">Invoice to</p></div>
         ...
         <div className=" flex justify-end mt-6  text-lg font-bold ">
           <div className=" text-white px-4 p-4 print:!bg-[#004e5a]"  style={{ backgroundColor: '#004e5a' }}>
